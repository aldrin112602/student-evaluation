...
position: relative;">
    ...
    <div class="row text-center shadow-lg rounded p-5" style="background-color: rgba(255, 255, 255, 0.8); border-radius: 15px; box-shadow: 0px 10px 20px rgba(0, 0, 0, 0.1); position: relative; align-items: center;">

        <!-- Wesleyan Logo (Left Side) -->
        <div class="col-md-4 mb-4 d-flex justify-content-center align-items-center">
            <img src="{{ asset('images/wesleyanlogo.jpg') }}" alt="Wesleyan Logo" class="img-fluid logo-animation" style="width: 150px; height: 150px; object-fit: cover; border: 5px solid #118B50;">
        </div>
        ...
        <div class="col-md-4 mb-4 d-flex justify-content-center align-items-center">
            <img src="{{ asset('images/logo.jpg') }}" alt="Logo" class="img-fluid logo-animation" style="width: 150px; height: 150px; object-fit: cover; border: 5px solid #007bff;">
        </div>
    </div>
...
<style>
    ...
    /* Smooth fade-in transition for main text */
    .animate__fadeIn {
        animation-duration: 1s;
